const productsMap = {
    "product1": {price: 300, checkbox: false, select: false},  // только товар
    "product2": {price: 250, checkbox: true, select: false}, // с чекбоксом
    "product3": {price: 200,checkbox: false, select: true} // с селектом услуг
};
const selectMap = {"select1": 30, "select2": 20, "select3": 25, "select4": 40};
